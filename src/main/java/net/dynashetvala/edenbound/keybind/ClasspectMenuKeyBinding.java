...
package net.dynashetvala.edenbound.keybind;
...
public class ClasspectMenuKeyBinding extends EdenboundModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public ClasspectMenuKeyBinding(EdenboundModElements instance) {
		super(instance, 43);
	...
	public void initElements() {
		keys = new KeyBinding("key.mcreator.classpect_menu", GLFW.GLFW_KEY_C, "key.categories.edenbound");
