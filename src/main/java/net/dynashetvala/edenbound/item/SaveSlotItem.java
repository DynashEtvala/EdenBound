...
import net.dynashetvala.edenbound.gui.NewSaveGUIGui;
...
public class SaveSlotItem extends EdenboundModElements.ModElement {
	@ObjectHolder("edenbound:save_slot")
	public static final Item block = null;
	public SaveSlotItem(EdenboundModElements instance) {
		super(instance, 45);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(EdenboundItemsItemGroup.tab).maxStackSize(1));
			setRegistryName("save_slot");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This feels like it could hold all of your personality."));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Save Slot");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new NewSaveGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
