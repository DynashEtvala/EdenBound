...
public class PerfectlyGenericSlabBlock extends EdenboundModElements.ModElement {
	@ObjectHolder("edenbound:perfectly_generic_slab")
	public static final Block block = null;
	public PerfectlyGenericSlabBlock(EdenboundModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("perfectly_generic_slab");
		}
