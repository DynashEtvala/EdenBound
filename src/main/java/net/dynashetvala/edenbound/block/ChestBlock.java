...
public class ChestBlock extends EdenboundModElements.ModElement {
	@ObjectHolder("edenbound:chest")
	public static final Block block = null;
	public ChestBlock(EdenboundModElements instance) {
		super(instance, 25);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			switch ((Direction) state.get(FACING)) {
				...
				case SOUTH :
				default :
					return VoxelShapes.create(0.9375D, 0D, 0.938D, 0.062D, 0.875D, 0.062D);
				case NORTH :
					return VoxelShapes.create(0.0625D, 0D, 0.062D, 0.938D, 0.875D, 0.938D);
				case WEST :
					return VoxelShapes.create(0.062D, 0D, 0.9375D, 0.938D, 0.875D, 0.062D);
				case EAST :
					return VoxelShapes.create(0.938D, 0D, 0.0625D, 0.062D, 0.875D, 0.938D);
			}
		}
